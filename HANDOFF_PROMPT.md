...
> **Copy and paste the prompt block below to any AI assistant on your other PC to immediately get it 100% caught up to speed on this codebase and deployment!**
...
- **Primary Server Lock**: Guild ID `1468916727940382786` (Invite: `https://discord.gg/9GRTstjc6b`). The bot auto-leaves any other guild.
...
1. Extract `eccos-girl-bot.zip`.
2. Run `npm install` to install dependencies (`discord.js`, `express`, `express-session`).
3. Deploy commands: `node src/deploy-commands.js`
4. Start server & bot locally: `node index.js`
5. Cloud auto-deployment: Any push to `main` branch automatically builds and deploys to Render.com.
